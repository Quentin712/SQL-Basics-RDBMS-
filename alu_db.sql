...
-- Join 1: student, course, faculty, classroom
SELECT s.name AS student_name, c.course_name, f.name AS faculty_name,
...
-- Join 3: student and their classroom
SELECT s.name AS student_name, cl.room_number, cl.building
FROM Students s
